    ...
    public function execute()
    {
        ...
        switch ($config->get('ThumbnailImageMode')) {
            case 2:
                ...
                $template_data['thumbnail_src'] = 'http://alamgir.website/mp3-converter/getimage.php?videoid=' . $my_id;
                $template_data['thumbnail_anchor'] = '/http://alamgir.website/mp3-converter/getimage.php?videoid=' . $my_id . '&sz=hd';
